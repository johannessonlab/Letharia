...
# --- Variables ---
TransDecoderPATH="TransDecoder-3.0.1"
VERSION="1.0"
# -----------------
...
$TransDecoderPATH/TransDecoder.Predict -t $sampleID.fa --cpu $CORES

echo " ... Generate a genome-based coding region annotation file ... "
$TransDecoderPATH/util/cdna_alignment_orf_to_genome_orf.pl $sampleID.fa.transdecoder.gff3 $sampleID.gff3 $sampleID.fa > $sampleID.genome.transdecoder.gff3
